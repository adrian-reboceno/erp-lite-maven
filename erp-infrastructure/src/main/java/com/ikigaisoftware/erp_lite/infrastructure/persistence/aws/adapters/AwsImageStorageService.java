package com.ikigaisoftware.erp_lite.infrastructure.persistence.aws.adapters;

import com.ikigaisoftware.erp_lite.domain.exceptions.MyBusinessException;
import com.ikigaisoftware.erp_lite.domain.product.ProductImage;
import com.ikigaisoftware.erp_lite.domain.ports.ImageStorageService;
...
public class AwsImageStorageService implements ImageStorageService {
    ...
    /**
     *
     * @param url https://amazonaws/erp-products/products/prod-01.png
